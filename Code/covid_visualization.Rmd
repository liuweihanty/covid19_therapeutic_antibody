...
covid <- read_excel("/Users/weihan/Desktop/华人抗体协会/covid_analysis/covid19_therapeutic_antibody/Data/Covid19_Ab_Track2020_07_03.xlsx")
...
#change all the clinical status number to roman numbers
sub_piece$Status[sub_piece$Status == "Phase 1"] <- "Phase I"
sub_piece$Status[sub_piece$Status == "Phase 1/2"] <- "Phase I/II"
sub_piece$Status[sub_piece$Status == "Phase 1/2/3"] <- "Phase I/II/III"
sub_piece$Status[sub_piece$Status == "Phase 2"] <- "Phase II"
sub_piece$Status[sub_piece$Status == "Phase 2/3"] <- "Phase II/III"
sub_piece$Status[sub_piece$Status == "Phase 3"] <- "Phase III"
...
sub_piece$Status <- factor(sub_piece$Status, levels = c("Approved","Phase I/II/III","Phase III","Phase II/III","Phase II","Phase I/II","Phase I","Clinical pending","Preclinical","Discovery"))
...
country_plot
ggsave("fig3_clinical_status_by_country.png", dpi=600, height=6, width=10, units="in")
```
